...
<div id="header">
   <div id="banner">
      <span id="logo"><a href="{$style:context}/rest/db/dma/index.xq"><img src="{$style:context}/rest/db/dma/apps/tei-annotator/images/tei-banner.jpg" alt="danmccreary" width="250" height="58"/></a></span>   
      
      <span id="banner-header-text">TEI Annotator</span>
